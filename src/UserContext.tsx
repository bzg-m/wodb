...
function pickStubUserFromEmail(email: string): AuthUser {
    ...
    if (lc.includes('admin')) return { id: 'admin', name: 'Admin', isAdmin: true } as AuthUser;
    if (lc.includes('bob')) return { id: 'u2', name: 'Bob', isAdmin: false } as AuthUser;
    // default to Alice
    return { id: 'u1', name: 'Alice', isAdmin: false } as AuthUser;
}
